...
const features = [
  {
    ...
    icon: LanguageIcon,
    skills: [
      'html','css','js','php','python','java','react'
    ]
  },
  {
    name: 'Framework', 
        ...
        <div className="mx-auto flex flex-col gap-y-16">
          <div className="w-full">
            <div className="text-center relative">
              ...
              <h2 className="text-lg font-semibold text-indigo-600 animate-fade-in">Tentang Saya</h2>
              <p className="mt-4 text-6xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent animate-slide-up">
                {profileData.name}
              </p>
